...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            var currPage = sessionStorage.getItem('foundCurrPage');
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (status == 'true') {
                        ...
                        sessionStorage.setItem('foundCurrPage', currPage);
                        data = data.list;
                        $.each(data, function (index, listEntity) {
                            list += '   <li class="list-group-item">\n' +
                                '                    <span class="badge">' + listEntity.addtime + '</span>\n' +
                                '                    <a style="color:#5A5A5A;" href="/found/content?id=' + listEntity.id + '">' + listEntity.wupinmingcheng + '（' + listEntity.zhuangtai + '）\n</a>' +
                                '                </li>';
                        });
...
<div class="container" style="margin-top: 100px">
    <div style="background-color: #f5f5f5;border-radius: 5px;">
        <ul class="breadcrumb" style="display: inline-block;margin-bottom: 5px">
            ...
            <li class="active"><a style="color:#5A5A5A;">寻物公告</a></li>
        </ul>
