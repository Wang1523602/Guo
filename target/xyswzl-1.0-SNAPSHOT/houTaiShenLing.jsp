...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var zhuangtai = sessionStorage.getItem('HTSLzhuangtai');
        ...
        function LoadList(zhuangtai) {
            sessionStorage.setItem('HTSLzhuangtai', zhuangtai);
            console.log(zhuangtai);
            //重置标题列表
                        ...
                        if (status == 'true') {
                            ...
                            $.each(data, function (index, listEntity) {
                                ...
                                table += '<tr>\n' +
                                    ...
                                    '                        <td>\n' +
                                    '                            <div class="btn-group">\n' +
                                    '                                <a href="/lost/HTSLSHContent?id=' + listEntity.id + '" class="btn btn-default">查看</a>\n' +
                                    '                                <a href="/lost/HTSLSHTYUpdate?id=' + listEntity.id + '" class="btn btn-success">同意</a>\n' +
                                    '                                <a href="/lost/HTSLSHJJUpdate?id=' + listEntity.id + '" class="btn btn-danger">拒绝</a>\n' +
                                    '                            </div>\n' +
                                    '                        </td>\n' +
                                    '                    </tr>';
                            });
                        ...
                        if (status == 'true') {
                            ...
                            $.each(data, function (index, listEntity) {
                                ...
                                table += '<tr>\n' +
                                    ...
                                    '                            <div class="btn-group">\n' +
                                    '                                <a href="/lost/HTSLSHContent?id=' + listEntity.id + '" class="btn btn-default">查看</a>\n' +
                                    '                                <a href="/lost/HTSLSHWCUpdate?id=' + listEntity.id + '" class="btn btn-success">提交完成</a>\n' +
                                    '                                <a href="/lost/HTSLSHDelete?id=' + listEntity.id + '" class="btn btn-danger" onclick="return deleteConfirm()">删除</a>\n' +
                                    '                            </div>\n' +
                                    '                        </td>\n' +
                                    '                    </tr>';
                            });
...
<div class="container" style="margin-top: 100px;">
    <div class="row">
        <div class="col-sm-2">
            ...
            <a href="/houTaiShenLing.jsp" class="list-group-item active" id="renlingbtn"
