        ...
        function logOut() {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (status == 200) {
                        window.location.href = "/pingtaizhinan.jsp";
                    } else {
                        alert("退出失败！");
                    }
                },
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                       ...
                       <li><a href="/liuyanqiang.jsp">留言墙</a></li>
                        ...
                        <li class="active"><a href="/pingtaizhinan.jsp">平台指南</a></li>
                    </ul>
...
<div class="container" style="padding:0 28px;margin-top: 100px;">
    ...
    <div class="row" style="background-color: #ffffff;border-radius: 5px;">
        <div class="content-wrapper__router">
            <ul class="breadcrumb">
                <li class="active"><a style="color:#5A5A5A;">平台指南</a></li>
            </ul>
        </div>
        <div  style="text-align: center">
        <span style="font-size: 20px;">温馨提示：部分功能需登录账号方可使用，如上传物品信息，查看物品详情，发表留言!上传信息后请耐心等待管理员审核！</span>
     <img src="../images/liucheng.JPG" style="width: 100%;height: 100%">
        </div>
    </div>
</div>
