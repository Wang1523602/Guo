...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            // LoadList();
            var zhuangtai = sessionStorage.getItem('XWzhuangtai');
        ...
        function LoadList(zhuangtai) {
            ...
            sessionStorage.setItem('XWzhuangtai', zhuangtai);
                        ...
                        if (status == 'true') {
                            ...
                            $.each(data, function (index, listEntity) {
                                ...
                                table += '<tr>\n' +
                                    ...
                                    '                        <td>\n' +
                                    '                            <div class="btn-group">\n' +
                                    '                                <a href="/found/XWSHContent?id=' + listEntity.id + '" class="btn btn-default">查看</a>\n' +
                                    '                                <a href="/found/XWSHDelete?id=' + listEntity.id + '" class="btn btn-danger" onclick="return deleteConfirm()">删除</a>\n' +
                                    '                            </div>\n' +
                                    '                        </td>\n' +
                                    '                    </tr>';
                            });
                        ...
                        if (status == 'true') {
                            ...
                            $.each(data, function (index, listEntity) {
                                ...
                                table += '<tr>\n' +
                                    ...
                                    '                        <td>\n' +
                                    '                            <div class="btn-group">\n' +
                                    '                                <a href="/found/XWContent?id=' + listEntity.id + '" class="btn btn-default">查看</a>\n' +
                                    '                                <a href="/found/XWDelete?id=' + listEntity.id + '" class="btn btn-danger" onclick="return deleteConfirm()">删除</a>\n' +
                                    '                            </div>\n' +
                                    '                        </td>\n' +
                                    '                    </tr>';
                            });
...
<div class="container" style="margin-top: 100px;">
    <div class="row">
        <div class="col-sm-2">
            <a href="/userXunWu.jsp" class="list-group-item active" id="xunwubtn"
