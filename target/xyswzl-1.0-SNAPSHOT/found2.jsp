        ...
        function logOut() {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (status == 200) {
                        window.location.href = "/found2.jsp";
                    } else {
                        alert("退出失败！");
                    }
                },
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="/found.jsp">寻物</a></li>
                    ...
                    <form action="/found/search" method="post">
                        <div class="navbar-form navbar-left" role="search">
                            <div class="form-group">
                                <input type="text" name="wupinmingcheng" class="form-control" placeholder="仅搜索寻物">
...
<div class="container" style="margin-top: 100px">
    <div style="background-color: #f5f5f5;border-radius: 5px;">
        <ul class="breadcrumb" style="display: inline-block;margin-bottom: 5px">
            ...
            <li><a href="/found.jsp" style="color:#5A5A5A;">寻物公告</a></li>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">上传寻物信息</h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <div style="display: inline-block;margin-left:0px;">
                            <div class="form-group">
                                ...
                                <label for="shiquren">&nbsp;&nbsp;&nbsp;失主姓名：</label>
                                <input type="text" name="shiquren" id="shiquren"/>
                            </div>
                            <div class="form-group">
                                <label for="lianxidianhua">联系电话：</label>
                                <input type="text" name="lianxidianhua" id="lianxidianhua"/>
                                <label for="shiquriqi">&nbsp;&nbsp;&nbsp;丢失日期：</label>
                                <input type="date" name="shiquriqi" id="shiquriqi"/>
                            </div>
                            <div class="form-group">
                                <label for="shiqudizhi">丢失地址：</label>
                                <input type="text" name="shiqudizhi" id="shiqudizhi"/>
                                <label for="zhandianmingcheng">&nbsp;&nbsp;&nbsp;期望归还站点：</label>
...
//存在
                                    ...
                                    var shiquren = $("#shiquren").val();
                                    var lianxidianhua = $("#lianxidianhua").val();
                                    var shiquriqi = $("#shiquriqi").val();
                                    var shiqudizhi = $("#shiqudizhi").val();
                                    ...
                                    if (shiquriqi.length == 0) {
                                        alert("请选择丢失日期！");
                                        return false;
                                    }
                                    if (shiqudizhi.length == 0) {
                                        alert("请填写丢失地址！");
                                        return false;
                                    }
    ...
    <div class="row" style="padding:0 15px;">
                ...
                <c:when test="${dbWupin!=null}">
                   ...
                   <span class="badge"> <fmt:formatDate value="${res.addtime}" pattern="yyyy-MM-dd"></fmt:formatDate>
                            ...
                            <a style="color:#5A5A5A;"
                               href="/found/content?id=${res.id}">${res.wupinmingcheng}（${res.zhuangtai}）</a>
                        </li>
                    </c:forEach>
                </c:when>
                <c:otherwise>
        ...
        <div style="text-align:center">
            <div class="pagination" style="color: #ffffff">
                <a id="firstPageId" style="color: #ffffff" href="/found2.jsp?begin=1">首页</a>
                <c:if test="${sessionScope.page_current != 1 }">
                    <a id="prevPageId" style="color: #ffffff"
                       href="/found2.jsp?begin=${sessionScope.page_current - 1 }">上一页</a>
                </c:if>
                <c:if test="${sessionScope.page_current != sessionScope.page_total &&sessionScope.page_total!=0 }">
                    <a id="nextPageId" style="color: #ffffff"
                       href="/found2.jsp?begin=${sessionScope.page_current + 1 }">下一页</a>
                </c:if>
                <a id="lastPageId" style="color: #ffffff" href="/found2.jsp?begin=${sessionScope.page_total }">尾页</a>
