...
<div class="container" style="margin-top: 100px;">
    <div class="row">
        ...
        <div class="col-sm-10">
            <ol class="breadcrumb">
                <li class="active"><a href="/userShenLing.jsp" style="color: #5a5a5a;">申领信息管理</a></li>
                ...
                <div class="table-responsive" style="background-color: #ffffff;border-radius: 5px;">
                    ...
                    <div class="col-md-7" style="display: inline-block;">
                        <div style="margin-left:20px;margin-right:20px;">
                            ...
                            <c:choose>
                                <c:when test="${(dbWupin!=null and dbWupin.shenhejieguo=='审核中') or (dbWupin!=null and dbWupin.shenhejieguo=='拒绝')}">
