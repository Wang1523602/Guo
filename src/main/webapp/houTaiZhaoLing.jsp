...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var zhuangtai = sessionStorage.getItem('HTZLzhuangtai');
        ...
        function LoadList(zhuangtai) {
            ...
            sessionStorage.setItem('HTZLzhuangtai', zhuangtai);
                        ...
                        if (status == 'true') {
                            ...
                            $.each(data, function (index, listEntity) {
                                ...
                                table += '<tr>\n' +
                                    ...
                                    '                        <td>' + listEntity.jiandaoriqi + '</td>\n' +
                                    '                        <td>' + listEntity.daozhandianriqi + '</td>\n' +
                                    '                        <td>' + listEntity.zhandianmingcheng + '</td>\n' +
                                    '                        <td>' + listEntity.zhuangtai + '（' + listEntity.shenhejieguo + '）</td>\n' +
                                    '                        <td>\n' +
                                    '                            <div class="btn-group">\n' +
                                    '                                <a href="/lost/HTZLSHContent?id=' + listEntity.id + '" class="btn btn-default">查看</a>\n' +
                                    '                                <a href="/lost/HTZLSHTYUpdate?id=' + listEntity.id + '" class="btn btn-success">同意</a>\n' +
                                    '                                <a href="/lost/HTZLSHJJUpdate?id=' + listEntity.id + '" class="btn btn-danger">拒绝</a>\n' +
                                    '                            </div>\n' +
                                    '                        </td>\n' +
                                    '                    </tr>';
                            });
                        ...
                        if (status == 'true') {
                            ...
                            $.each(data, function (index, listEntity) {
                                ...
                                table += '<tr>\n' +
                                    ...
                                    '                        <td>\n' +
                                    '                            <div class="btn-group">\n' +
                                    '                                <a href="/lost/HTSWZLContent?id=' + listEntity.id + '" class="btn btn-default">查看</a>\n' +
                                    '                                <a href="/lost/HTSWZLWCUpdate?id=' + listEntity.id + '" class="btn btn-success">提交完成</a>\n' +
                                    '                                <a href="/lost/HTSWZLDelete?id=' + listEntity.id + '" class="btn btn-danger" onclick="return deleteConfirm()">删除</a>\n' +
                                    '                            </div>\n' +
                                    '                        </td>\n' +
                                    '                    </tr>';
                            });
...
<div class="container" style="margin-top: 100px;">
    <div class="row">
        <div class="col-sm-2">
            <a href="/houTaiIndex.jsp" class="list-group-item" id="xunwubtn">
                <span class="glyphicon glyphicon-align-left"></span>寻物信息管理
            </a>
            <a href="/houTaiZhaoLing.jsp" class="list-group-item active" id="zhaolingbtn"
