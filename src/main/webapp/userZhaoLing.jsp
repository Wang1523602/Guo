...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            // LoadList();
            var zhuangtai = sessionStorage.getItem('ZLzhuangtai');
        ...
        function LoadList(zhuangtai) {
            ...
            sessionStorage.setItem('ZLzhuangtai', zhuangtai);
            //重置标题列表
                        ...
                        if (status == 'true') {
                            ...
                            $.each(data, function (index, listEntity) {
                                ...
                                table += '<tr>\n' +
                                    ...
                                    '                        <td>\n' +
                                    '                            <div class="btn-group">\n' +
                                    '                                <a href="/lost/ZLSHContent?id=' + listEntity.id + '" class="btn btn-default">查看</a>\n' +
                                    '                                <a href="/lost/ZLSHDelete?id=' + listEntity.id + '" class="btn btn-danger" onclick="return deleteConfirm()">删除</a>\n' +
                                    '                            </div>\n' +
                                    '                        </td>\n' +
                                    '                    </tr>';
                            });
                        ...
                        if (status == 'true') {
                            ...
                            $.each(data, function (index, listEntity) {
                                ...
                                table += '<tr>\n' +
                                    ...
                                    '                        <td>\n' +
                                    '                            <div class="btn-group">\n' +
                                    '                                <a href="/lost/ZLContent?id=' + listEntity.id + '" class="btn btn-default">查看</a>\n' +
                                    '                                <a href="/lost/ZLDelete?id=' + listEntity.id + '" class="btn btn-danger" onclick="return deleteConfirm()">删除</a>\n' +
                                    '                            </div>\n' +
                                    '                        </td>\n' +
                                    '                    </tr>';
                            });
...
<div class="container" style="margin-top: 100px;">
    <div class="row">
        <div class="col-sm-2">
            ...
            <a href="/userZhaoLing.jsp" class="list-group-item active" id="zhaolingbtn"
            ...
            <a href="/userShenLing.jsp" class="list-group-item" id="renlingbtn">
                        <span class="glyphicon glyphicon-align-left" aria-hidden="true">
                    </span>申领信息管理</a>
        </div>
        <!--左边菜单栏-->
