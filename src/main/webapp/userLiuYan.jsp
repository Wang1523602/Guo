                    ...
                    if (status == 'true') {
                        ...
                        $.each(data, function (index, listEntity) {
                            ...
                            table += '<tr>\n' +
                                ...
                                '                        <td>\n' +
                                '                            <div class="btn-group">\n' +
                                '                                <a href="/liuyan/LYDelete?id=' + listEntity.id + '" class="btn btn-danger" onclick="return deleteConfirm()">删除</a>\n' +
                                '                            </div>\n' +
                                '                        </td>\n' +
                                '                    </tr>';
                        });
...
<div class="container" style="margin-top: 100px;">
    <div class="row">
        <div class="col-sm-2">
            ...
            <a href="/userLiuYan.jsp" class="list-group-item active" id="liuyanbtn"
